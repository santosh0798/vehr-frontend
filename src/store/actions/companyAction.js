...
export const updateCompany = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(' https://54.145.254.42:4000/api/v1/company/update', userData, config);
        dispatch({
...
export const getCompany = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(' https://54.145.254.42:4000/api/v1/company/mylist', config);
        dispatch({
...
export const updateCompanyAllowance = (data) => async (dispatch) => {
    try {
        ...
        const datas = await axios.post(' https://54.145.254.42:4000/api/v1/company/allowance', {
            data: data
        }, config);
        dispatch({
