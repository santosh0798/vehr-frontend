...
export const updateCompany = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(' http://3.86.184.176:4000/api/v1/company/update', userData, config);
        dispatch({
...
export const getCompany = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(' http://3.86.184.176:4000/api/v1/company/mylist', config);
        dispatch({
...
export const updateCompanyAllowance = (data) => async (dispatch) => {
    try {
        ...
        const datas = await axios.post(' http://3.86.184.176:4000/api/v1/company/allowance', {
            data: data
        }, config);
        dispatch({
